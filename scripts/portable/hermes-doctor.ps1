...
$SH_WIN = Join-Path $ROOT_WIN "runtime\hermes\doctor-portable.sh"
...
echo "[Mamabot] HOME=\$HOME"
echo "[Mamabot] HERMES_BIN=\$HERMES_HOME/hermes-agent/venv/bin/hermes"
...
timeout 120s ./venv/bin/hermes doctor || true
"@

...
export function loadPortableEnv() {
  ...
  const runtimeHermesHome = path.join(root, "runtime", "hermes", "home");
  ...
  return {
    ...
    ...parseEnvFile(path.join(runtimeHermesHome, ".env")),
    ...parseEnvFile(path.join(runtimeHermesHome, ".env.local")),
    ...process.env
  };
}
